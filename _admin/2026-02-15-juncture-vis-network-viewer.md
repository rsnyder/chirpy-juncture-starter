---
title: "Juncture: Network Viewer"
description: How to use the Juncture Network Viewer to display graph and network diagrams in your Markdown posts.
permalink: /admin/juncture-vis-network-viewer
date: 2026-02-15
...
The Juncture Network Viewer renders interactive **node-and-edge diagrams** directly in your post. It is suited to any content where relationships between things matter: family trees, concept maps, dependency graphs, organisational charts, and similar structures.
...
If you omit `dataid`, the viewer asks the parent page for its own iframe `id` and then looks for a data element named `{id}-csv`. This means you can let Juncture assign the id automatically and name your data block to match.
